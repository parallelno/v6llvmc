...
| sieve | 303 B / 84,904 cc (1.00x) | 178 B / 86,348 cc (1.02x) | 178 B / 86,348 cc (1.02x) | 212 B / 148,184 cc (1.75x) | 1342 B / 195,472 cc (2.30x) |
| fib_crc | 631 B / 67,328 cc (1.00x) | 241 B / 85,876 cc (1.28x) | 229 B / 82,972 cc (1.23x) | 308 B / 268,204 cc (3.98x) | 1155 B / 284,048 cc (4.22x) |
...
- **v6llvmc**: `clang -target i8080-unknown-v6c -O2 -mllvm -mv6c-spill-patched-reload prog.c -o prog.rom`
