	.text
	.section	.text.lxi_lo_used,"ax",@progbits
...
; %bb.0:
	...
	RET
                                        ; -- End function
	.section	.text.lxi_hi_used,"ax",@progbits
...
; %bb.0:
	...
	RET
                                        ; -- End function
	.section	.text.lxi_lo_to_b,"ax",@progbits
...
; %bb.0:
	...
	RET
                                        ; -- End function
	.section	.text.lxi_lo_zero,"ax",@progbits
