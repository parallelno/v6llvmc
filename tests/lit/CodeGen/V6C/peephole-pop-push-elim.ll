...
;
; -- Case 1 (enabled) ----------------------------------------------------------
; In the .LLo61_10 slot update (outer-loop i_sq computation), the redundant
; POP H / PUSH H pair is removed: MOV C, L is directly followed by MOV L, C.
; CHECK:      .LLo61_10:
; CHECK-NEXT: LXI     B, 0
; CHECK-NEXT: PUSH    H
; CHECK-NEXT: DAD     B
...
; With O83 the surrounding POP H / PUSH H is removed: MOV B, H is directly
; followed by INX B.
